            ...
            <section className="py-24 px-4 md:px-12">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 data-aos="fade-right" className="text-4xl font-bold mb-6 text-[#ba8b4e] font-display">Our Story</h2>
                            <p data-aos="fade-left" data-aos-delay="200" className="text-lg text-gray-700 leading-relaxed">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
                        <div className="md:order-2">
                            <h2 data-aos="fade-left" className="text-4xl font-bold mb-6 text-[#ba8b4e] font-display">Our Vision</h2>
                            <p data-aos="fade-right" data-aos-delay="200" className="text-lg text-gray-700 leading-relaxed mb-6">
                            ...
                            <p data-aos="fade-right" data-aos-delay="400" className="text-lg text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-[#ba8b4e] rounded-lg p-12 mb-20">
                        <h2 data-aos="fade-up" className="text-4xl font-bold mb-6 text-white font-display text-center">Our Heritage</h2>
                        <p data-aos="fade" data-aos-delay="200" className="text-lg text-white leading-relaxed mb-6 text-center max-w-4xl mx-auto">
                        ...
                        <p data-aos="fade" data-aos-delay="400" className="text-lg text-white leading-relaxed text-center max-w-4xl mx-auto">
                    ...
                    <div className="text-center">
                        <h2 data-aos="zoom-in" className="text-4xl font-bold mb-8 text-[#ba8b4e] font-display">Experience Egypt Like Never Before</h2>
                        <p data-aos="fade-up" data-aos-delay="200" className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">

        ...
        <div>
            ...
            <div className="py-32 px-6 bg-gradient-to-b from-palace-900 to-palace-800">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-brand-50/10 backdrop-blur-sm rounded-2xl p-16 border border-brand-400/20">
                        <h2 className="text-5xl font-bold mb-6 text-brand-400 font-display">Coming Soon</h2>
                        <p className="text-xl text-brand-100/80 mb-8 leading-relaxed">
                            Our online booking system is currently under development. 
                        </p>
                        <p className="text-lg text-brand-200/70 mb-12">
                        ...
                        <div className="text-brand-300/60">
